...
export const Options = ({ height = 120 }: OptionsProps) => {
  const dark = prefersColorSchemeDark()

  const shirtAndShoeColor = dark ? '#838383' : '#3f3d56'
  const pantsColor = dark ? '#156176' : '#3f3d56'
  const hairColor = dark ? '#6c590a' : '#2f2e41'
  const accentColor = dark ? '#1c7c96' : '#1c7c96'
  const boardColor = dark ? '#454551' : '#fff'
  const boardBorderColor = dark ? boardColor : '#e5e5e5'
  ...
  return (
    ...
    >
      <path
        id="a24dc8e0-63f3-4c57-9da7-8d00cfa1aebe-296"
      ...
      />
      <path
        id="bc8b2ee0-9ec2-4139-a7e3-e0b1b1382397-297"
      ...
      />
      <path
        id="a6bcb68f-fec1-4497-88cc-56de52c10faf-298"
      ...
      />
      <path
        id="a1650e23-bf32-4c95-848c-aacb59e17a01-299"
