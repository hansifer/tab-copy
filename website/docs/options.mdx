...
Clicking a format's tile toggles its visibility in the app. When a format is hidden, it won't show up in the [popup format selector](./popup/format-selector) or [context menus](./context-menu).
...
This changes the order in which formats are displayed in the [popup format selector](./popup/format-selector) and [context menus](./context-menu).
